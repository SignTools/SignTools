...
replace (
	github.com/tus/tusd/v2 v2.10.0 => github.com/SignTools/tusd/v2 v2.0.0-20260716144328-8379fca867cb
	software.sslmate.com/src/go-pkcs12 v0.7.3 => github.com/SignTools/go-pkcs12 v0.0.0-20260716144310-901ab8d8d132
)
